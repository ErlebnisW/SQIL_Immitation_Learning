...
if __name__ == "__main__":
    ...
    expert_memory_replay.load('e/home/richard/Codes/football/sqil/soft-Q-learning/expert_replay.npy')
    ...
    for epoch in count():
        ...
        for time_steps in range(200):
            ...
            online_memory_replay.add((state, next_state, action, 0., done))         # Adds O reward for every step initially
